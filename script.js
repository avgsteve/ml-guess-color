...
function setRandomColor() {
  ...
  let guestWhite = 'The color most contrary to the backgroud is WHITE 在現在的背景色中，對比最強烈的顏色是白色 ?'
  let guestBlack = 'The color most contrary to the backgroud is BLACK在現在的背景色中，對比最強烈的顏色是黑色?'


  guessEl.innerText = `${guess>.5 ? guestWhite :guestBlack}`
